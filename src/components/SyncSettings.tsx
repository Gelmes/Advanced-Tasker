...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: font.sm, color: color.inkSoft, marginTop: 2, marginBottom: 12 },
  fieldLabel: { fontSize: font.sm, color: color.inkSoft, marginBottom: 4, marginTop: 8 },
  field: {
    borderWidth: 1,
  ...
  hint: { fontSize: font.xs, color: color.inkSoft, marginTop: 6 },
  meta: { fontSize: font.xs, color: color.inkSoft, marginTop: 10 },
  ...
  primaryText: { fontSize: font.md, color: color.appBg, fontWeight: '600' },
  disabled: { opacity: 0.5 },
  status: { fontSize: font.sm, color: color.inkMid, marginTop: 12 },
  divider: { height: 1, backgroundColor: color.border, marginTop: 16, marginBottom: 4 },
  err: { fontSize: font.sm, color: color.danger, marginTop: 6 },
  ...
  listName: { fontSize: font.md, color: color.inkMid, flexShrink: 1, flexGrow: 1 },
  listPull: { fontSize: font.sm, color: color.accent, marginLeft: 8 },
  listDelete: { fontSize: font.sm, color: color.danger, marginLeft: 10, paddingHorizontal: 2 },
});
